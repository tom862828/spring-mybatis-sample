...
public class InsertController {
	...
	@PostMapping(value="/{user}/{password}/insertPerson", produces = "application/json")
	public ResponseEntity<PersonVO> insertPerson(@PathVariable("user") String user,@PathVariable("password") String password) {
